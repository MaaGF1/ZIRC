...
def farm_mission_10801(client: GFLClient):
    mission_id = 10801
    ...
    # Turn 1
    if check_step_error(move_ally(64318, 64307), "teamMove(64318->64307)"): return None
    time.sleep(0.2)
    
    if check_step_error(move_ally(64307, 64308), "teamMove(64307->64308)"): return None
    time.sleep(0.2)
    
    if check_step_error(client.send_request(API_MISSION_ALLY_MYSIDE_MOVE, {}), "allyMySideMove"): return None
    time.sleep(0.2)
    ...
    if check_step_error(client.send_request(API_MISSION_START_TURN, {}), "startTurn"): return None
    time.sleep(0.5)
    
    # Turn 2
    if check_step_error(move_ally(64308, 64302), "teamMove(64308->64302)"): return None
    time.sleep(0.2)
    
    # Final move finishes the mission and contains the drop info
    final_resp = move_ally(64302, 64319)
    if check_step_error(final_resp, "teamMove(64302->64319)"): return None
...
def farm_worker():
    ...
    print("=== GFL Protocol Auto-Farming Started (Mission 10801 PR) ===")
    for macro in range(1, CONFIG["MACRO_LOOPS"] + 1):
        ...
        for micro in range(1, CONFIG["MISSIONS_PER_RETIRE"] + 1):
            ...
            dropped = farm_mission_10801(client)
...
def print_menu():
    ...
    print(" -r : Run Auto-Farming (10801 System Echelon)")
